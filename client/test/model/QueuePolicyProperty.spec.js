...
(function(root, factory) {
  ...
  describe('QueuePolicyProperty', function() {
    it('should create an instance of QueuePolicyProperty', function() {
      // uncomment below and update the code to test QueuePolicyProperty
      //var instance = new PubsubServiceApi.QueuePolicyProperty();
      //expect(instance).to.be.a(PubsubServiceApi.QueuePolicyProperty);
    });
