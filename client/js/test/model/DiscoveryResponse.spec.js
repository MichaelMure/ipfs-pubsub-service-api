...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PubsubServiceApi.DiscoveryResponse();
  });
  ...
  describe('DiscoveryResponse', function() {
    it('should create an instance of DiscoveryResponse', function() {
      // uncomment below and update the code to test DiscoveryResponse
      //var instance = new PubsubServiceApi.DiscoveryResponse();
      //expect(instance).to.be.a(PubsubServiceApi.DiscoveryResponse);
    });
    ...
    it('should have the property maxTopics (base name: "max-topics")', function() {
      // uncomment below and update the code to test the property maxTopics
      //var instance = new PubsubServiceApi.DiscoveryResponse();
      //expect(instance).to.be();
    });
