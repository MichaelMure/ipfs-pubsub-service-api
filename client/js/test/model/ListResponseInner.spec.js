...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PubsubServiceApi.ListResponseInner();
  });
  ...
  describe('ListResponseInner', function() {
    it('should create an instance of ListResponseInner', function() {
      // uncomment below and update the code to test ListResponseInner
      //var instance = new PubsubServiceApi.ListResponseInner();
      //expect(instance).to.be.a(PubsubServiceApi.ListResponseInner);
    });
    ...
    it('should have the property queueLength (base name: "queue-length")', function() {
      // uncomment below and update the code to test the property queueLength
      //var instance = new PubsubServiceApi.ListResponseInner();
      //expect(instance).to.be();
    });

    it('should have the property queuePolicy (base name: "queue-policy")', function() {
      // uncomment below and update the code to test the property queuePolicy
      //var instance = new PubsubServiceApi.ListResponseInner();
      //expect(instance).to.be();
    });
    ...
    it('should have the property maxMessageSize (base name: "max-message-size")', function() {
