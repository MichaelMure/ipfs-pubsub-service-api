...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PubsubServiceApi.JoinResponse();
  });
  ...
  describe('JoinResponse', function() {
    it('should create an instance of JoinResponse', function() {
      // uncomment below and update the code to test JoinResponse
      //var instance = new PubsubServiceApi.JoinResponse();
      //expect(instance).to.be.a(PubsubServiceApi.JoinResponse);
    });
