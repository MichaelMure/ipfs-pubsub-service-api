...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PubsubServiceApi.DefaultApi();
  });
  ...
  describe('DefaultApi', function() {
    describe('discovery', function() {
      it('should call discovery successfully', function(done) {
        //uncomment below and update the code to test discovery
        //instance.discovery(function(error) {
    ...
    describe('filterPeerID', function() {
      it('should call filterPeerID successfully', function(done) {
        //uncomment below and update the code to test filterPeerID
        //instance.filterPeerID(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
