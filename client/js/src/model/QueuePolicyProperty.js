...
/**
* Enum class QueuePolicyProperty.
* @enum {}
* @readonly
*/
export default class QueuePolicyProperty {
    ...
    /**
    * Returns a <code>QueuePolicyProperty</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/QueuePolicyProperty} The enum <code>QueuePolicyProperty</code> value.
    */
