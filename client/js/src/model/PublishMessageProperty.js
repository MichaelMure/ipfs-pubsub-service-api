...
/**
 * The PublishMessageProperty model module.
 * @module model/PublishMessageProperty
 * @version 1.0.0
 */
class PublishMessageProperty {
    /**
     * Constructs a new <code>PublishMessageProperty</code>.
     * @alias module:model/PublishMessageProperty
     * @param data {String} The content encoded with base64 standard alphabet with padding.
     */
    constructor(data) { 
        
        PublishMessageProperty.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>PublishMessageProperty</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublishMessageProperty} obj Optional instance to populate.
     * @return {module:model/PublishMessageProperty} The populated <code>PublishMessageProperty</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublishMessageProperty();
    ...
    /**
     * Validates the JSON data with respect to <code>PublishMessageProperty</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublishMessageProperty</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PublishMessageProperty.RequiredProperties) {
...
PublishMessageProperty.RequiredProperties = ["data"];

/**
 * The content encoded with base64 standard alphabet with padding.
 * @member {String} data
 */
PublishMessageProperty.prototype['data'] = undefined;

/**
 * The peer ID of the sender. If not set, the client doesn't control the author of the message and the server will sign the message on behalf of the client.
 * @member {String} from
 */
PublishMessageProperty.prototype['from'] = undefined;

/**
 * The sender's public key encoded with base64 standard alphabet with padding in X.509 DER format. This should be set if `from` is used and the pubkey can't be extracted from `from` or `pubkey`. For example with a Ed25519 or Secp256k1 peerID, the public key can be extracted. With ECDSA, the pubkey can be extracted from the signature and can also be omitted. On the other hand, none of that is possible with RSA and `pubkey` should be set if `from` is used. 
 * @member {Blob} pubkey
 */
PublishMessageProperty.prototype['pubkey'] = undefined;

/**
 * The signature for the message. This should be set if `from` is used.
 * @member {Blob} signature
 */
PublishMessageProperty.prototype['signature'] = undefined;
...
export default PublishMessageProperty;
