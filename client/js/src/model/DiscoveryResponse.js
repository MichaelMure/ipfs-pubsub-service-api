...
/**
 * The DiscoveryResponse model module.
 * @module model/DiscoveryResponse
 * @version 1.0.0
 */
class DiscoveryResponse {
    /**
     * Constructs a new <code>DiscoveryResponse</code>.
     * Response schema for the /discovery endpoint.
     * @alias module:model/DiscoveryResponse
     */
    constructor() { 
        
        DiscoveryResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DiscoveryResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DiscoveryResponse} obj Optional instance to populate.
     * @return {module:model/DiscoveryResponse} The populated <code>DiscoveryResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DiscoveryResponse();
            ...
            if (data.hasOwnProperty('max-topics')) {
                obj['max-topics'] = ApiClient.convertToType(data['max-topics'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DiscoveryResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DiscoveryResponse</code>.
     */
 ...
 */
DiscoveryResponse.prototype['queue-length'] = undefined;

/**
 * The duration (in seconds) for which a pubsub topic remains subscribed after a /join operation.
 * @member {Number} timeout
 */
DiscoveryResponse.prototype['timeout'] = undefined;

/**
 * The maximum size (in bytes) allowed for a single pubsub message.
 * @member {Number} max-message-size
 */
DiscoveryResponse.prototype['max-message-size'] = undefined;

/**
 * The maximum number of pubsub topics a client can subscribe to.
 * @member {Number} max-topics
 */
DiscoveryResponse.prototype['max-topics'] = undefined;
