...
/**
 * The JoinResponse model module.
 * @module model/JoinResponse
 * @version 1.0.0
 */
class JoinResponse {
    /**
     * Constructs a new <code>JoinResponse</code>.
     * Response schema for the /join endpoint.
     * @alias module:model/JoinResponse
     * @param queueLength {Number} The maximum number of pubsub messages that can be stored by the service.
     * @param queuePolicy {module:model/QueuePolicyProperty} 
     * @param timeout {Number} The duration (in seconds) for which a pubsub topic remains subscribed after a /join operation.
     * @param maxMessageSize {Number} The maximum size (in bytes) allowed for a single pubsub message.
     */
    constructor(queueLength, queuePolicy, timeout, maxMessageSize) { 
        
        JoinResponse.initialize(this, queueLength, queuePolicy, timeout, maxMessageSize);
    }
     ...
     */
    static initialize(obj, queueLength, queuePolicy, timeout, maxMessageSize) { 
        obj['queue-length'] = queueLength;
        obj['queue-policy'] = queuePolicy;
        obj['timeout'] = timeout;
        obj['max-message-size'] = maxMessageSize;
    }

    /**
     * Constructs a <code>JoinResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/JoinResponse} obj Optional instance to populate.
     * @return {module:model/JoinResponse} The populated <code>JoinResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new JoinResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>JoinResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>JoinResponse</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of JoinResponse.RequiredProperties) {
